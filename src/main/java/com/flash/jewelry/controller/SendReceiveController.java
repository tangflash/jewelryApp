...
import com.flash.jewelry.service.SendReceiveSerivce;

@Controller
@RequestMapping("/sendReceiveBill*")
public class SendReceiveController {

	private final static String VIEW_EDIT_PAGE = "sendReceiveBillEdit";
	private final static String VIEW_LIST_PAGE = "sendReceiveBillList";
	...
	//@Autowired
	private SendReceiveSerivce sendReceiveSerivce;
	@Autowired
	...
	public ModelAndView showPage(String id) {
		...
		SendReceiveDetail sendReceiveDetail = sendReceiveSerivce.selectDetailById(id);

		modelAndView.setViewName(VIEW_EDIT_PAGE);
		modelAndView.addObject("sendReceiveDetail", sendReceiveDetail);	
	...
	@RequestMapping(value = "/doSaveDetail", method = RequestMethod.POST)
	public ModelAndView doSaveBillHead(
			@Valid @ModelAttribute("sendReceiveDetail") SendReceiveDetail sendReceiveDetail,
	...
	public ModelAndView findListPage(
		...
		Collection<SendReceiveDetail> list = sendReceiveSerivce
				.findList(queryParam);
	...
	public void doDelBillDetail(@Valid String id) {
		sendReceiveSerivce.deleteDetail(Long.valueOf(id));
	}
