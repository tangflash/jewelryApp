...
public class OrderController {
	...
	private final static String VIEW_EDIT_PAGE = "orderBillEdit";
	private final static String VIEW_LIST_PAGE = "orderBillList";
	...
	public ModelAndView showPage(String id) {
		...
		if (id == null || id.equals("")) {
			...
			materialOut.setOrderDate(new Date());
	...
	protected String saveBillHead(MaterialOut materialOut) {
		...
		if (materialOut.getOrderDate() == null) {
			errorMessage = "下单日期不能为空!";
			return errorMessage;
		}
		
		if (materialOut.getPlanFinishDate() == null) {
			errorMessage = "完成日期不能为空!";
			return errorMessage;
		}
