...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#planFinishDate").datepicker("option", "dateFormat", "yy-mm-dd");
			...
			<fieldset>
				...
				<table class="formTable">
					<tr>
						...
						<td>
							<form:label path="orderDate">
					  			下单日期: <form:errors path="orderDate" cssClass="error" />
							</form:label>
							<form:input id="orderDate" path="orderDate" tabindex="2"/>	
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<form:label path="planFinishDate">
					  			完成日期: <form:errors path="planFinishDate" cssClass="error" />
							</form:label>
							<form:input id="planFinishDate" path="planFinishDate" tabindex="6"/>	
						</td>
						<td>
				...
				<table class="formTable">
					<tr>	
						<td>
							...
							<form:input path="materialOutDetail.number" required="true" tabindex="7"/>
						</td>					
						<td>							
							...
							<form:input path="materialOutDetail.styleName" required="true" tabindex="8"/>
						</td>
						<td>
					...
					<tr>	
						<td>
							...
							<form:input path="materialOutDetail.handSize" tabindex="9"/>	
						</td>					
						<td>
							...
							<form:input id="input_productAmount" path="materialOutDetail.productAmount" tabindex="10"/>
						</td>
						<td>
							<form:label path="materialOutDetail.materName">
					  			主石号: <form:errors path="materialOutDetail.materName" cssClass="error" />
							</form:label>
							<form:input path="materialOutDetail.materName" tabindex="11"/>	
						</td>												
					</tr>					
					...
					<tr>											
						<td>
							...
							<form:input path="materialOutDetail.amount" tabindex="12"/>
						</td>
						<td>
							<form:label path="materialOutDetail.weight">
					  			主石重量: <form:errors path="materialOutDetail.weight" cssClass="error" />
							</form:label>
							<form:input id="input_weight" path="materialOutDetail.weight" tabindex="13"/>	
						</td>	
						<td>
							...
							<form:input path="materialOutDetail.secMaterName" tabindex="14"/>
						</td>										
					</tr>					
					<tr>							
						<td>
							...
							<form:input path="materialOutDetail.secAmount" tabindex="15"/>	
						</td>
						<td>
							<form:label path="materialOutDetail.secWeight">
					  			副石重量: <form:errors path="materialOutDetail.secWeight" cssClass="error" />
							</form:label>
							<form:input id="input_secWeight" path="materialOutDetail.secWeight" tabindex="16"/>	
						</td>				
						<td>
							<form:label path="materialOutDetail.remark">
					  			备注: <form:errors path="materialOutDetail.remark" cssClass="error" />
							</form:label>
							<form:input id="input_remark" path="materialOutDetail.remark" tabindex="17"/>	
						</td>												
					</tr>					
				</table>
								
				<p>
					<button type="submit" tabindex="18">保存</button>
